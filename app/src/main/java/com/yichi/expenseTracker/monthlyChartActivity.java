...
import com.yichi.expenseTracker.adapter.ChartViewPagerAdapter;
import com.yichi.expenseTracker.database.DBManager;
import com.yichi.expenseTracker.fragment_record.IncomeChartFragment;
import com.yichi.expenseTracker.fragment_record.expensesChartFragment;
...
public class monthlyChartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private com.yichi.expenseTracker.fragment_record.expensesChartFragment expensesChartFragment;
    ...
    private void initDatas(int year,int month) {
        ...
        tv_expenses.setText(getString(R.string.there_are)+" "
                + numberOfExpenses+" "+getString(R.string.expenses_here)
